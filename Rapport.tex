...
\bigskip
Après avoir adapter les lanceurs du site bureau à un usage sur tablette, le travail proposé était de les adapter aussi à une utilisation sur le site mobile. Même si Boostrap permet d'avoir un site web adaptatif, les lanceurs était trop chargé pour le mobile. Les aperçu était composé sur mobile de :
\begin{itemize}
\item une miniature de l'image du contenu,
\item en dessous se trouve le titre, la date ainsi que parfois un chapeau (selon les lanceurs).
\end{itemize} \par 
Afin d'avoir une interface adaptée au mobile, le chapeau fut retirer pour avoir un maximum d'aperçu sur une page.\par
