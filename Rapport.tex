...
La solution proposé par Bootstrap, bien que pratique, présentait un défaut qui rendait son utilisation peu pratique. Pour ouvrir une brève dans la liste il faut absolument cliquer sur son titre, bien qu'un bandeau, de même largeur que la portlet, entoure le titre et la date. La correction de ce défaut a nécessité une compréhension du système d'ouverture dynamique des brèves, afin de reproduire ce comportement lorsque l'on clique sur le bandeau. La correction ne devait pas perturbé le système de Bootstrap, mais devait être complémentaire. Tout ce qui touche la modification du DOM après la génération de celui-ci est possible grâce au Javascript et facilité avec la bibliothèque JQuery.\par 
\medskip
