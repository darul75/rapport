...
La deuxième version réglait les problèmes de navigation dans les sous menu, cependant, le menu reste en haut de la page. Le problème est que si le menu est d nouveau fixé en haut de la fenêtre, il n'est plus possible de scroller dans le menu, le fait d'être fixé empêche cela.\par
